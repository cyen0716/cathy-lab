// 1. 引入 Lucide 圖標組件型態與所有需要的質感線條圖標
import { 
  LucideIcon,
  Clock, 
  Palette, 
...
export interface VocabCategory {
  ...
  name: string
  nameKorean: string
  icon: LucideIcon // ✨ 關鍵：直接將 icon 規格升級為 Lucide 圖標類型
  words: VocabWord[]
}
