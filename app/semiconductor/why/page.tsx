...
<div className="flex items-center justify-center gap-6 md:gap-8 flex-wrap my-10">
  ...
  <div className="text-center">
    ...
    <p className="text-sm font-semibold text-slate-600 mt-3">One Transistor</p>
  </div>

  {/* 乘號 */}
  <p className="text-lg uppercase tracking-widest font-bold text-slate-600">
    × Billions
  </p>
  
  {/* 等號 */}
  <p className="text-2xl font-light text-slate-600">=</p>
  ...
  <div className="text-center">
    ...
    <p className="text-sm font-semibold text-slate-600 mt-3">Chip Matrix</p>
  </div>
