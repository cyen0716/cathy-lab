...
<div className="bg-white border border-slate-200/60 shadow-[0_2px_8px_rgba(15,23,42,0.01)] rounded-2xl pt-4 pb-2 px-4 lg:pt-4 lg:pb-2 lg:px-8 w-full">    <div className="hidden lg:grid lg:grid-cols-[160px_1fr_1fr] lg:gap-8 border-b border-slate-100 pb-3 mb-2 text-sm font-bold text-slate-700">
      <div></div>
      <div>SRAM (Static)</div>
      <div>DRAM (Dynamic)</div>
    </div>

    <div className="divide-y divide-slate-100/80 text-sm leading-snug">
      {[
      ...
      <div className="space-y-10 text-base leading-[1.85] text-slate-700">
        <section>
          ...
          {/* Density */}
          <div className="space-y-3.5">
          <h2 className="text-lg font-bold text-slate-900 mb-3 mt-8">1. Massive Physical Size (Density)</h2>
        <ul className="list-disc pl-4 ">
          ...
          {/* High Cost */}
          <div className="space-y-3.5">
          <h2 className="text-lg font-bold text-slate-900 mb-3 mt-8">2. High Cost</h2>
            <p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-8 max-w-2xl mx-auto">
            <div className="bg-white border border-slate-200 rounded-xl p-5 text-center">
              <p className="text-[13px] uppercase tracking-wider text-slate-400 font-semibold mb-3">DRAM</p>
              <div className="w-32 h-32 rounded-full border-2 border-dashed border-slate-300 mx-auto flex items-center justify-center bg-slate-50/50">
              ...
              <p className="text-xs text-slate-400 mt-2">Lower cost per unit</p>
            </div>

            <div className="bg-white border border-slate-200 rounded-xl p-5 text-center">
              <p className="text-[13px] uppercase tracking-wider text-slate-400 font-semibold mb-3">SRAM</p>
              <div className="w-32 h-32 rounded-full border-2 border-dashed border-slate-300 mx-auto flex items-center justify-center bg-slate-50/50">
              ...
              <p className="text-xs text-slate-400 mt-2">Higher manufacturing cost</p>
            </div>
          </div>
        ...
        {/* Continuous Power Consumption */}
          <div className="space-y-3.5">
          <h2 className="text-lg font-bold text-slate-900 mb-3 mt-8">3. Continuous Power Consumption</h2>                   
          <ul className="list-disc pl-4 ">
      ...
      <div className="space-y-10 text-base leading-[1.85] text-slate-700">
        <section>
          <h2 className="text-xl font-bold text-slate-900 mb-3">A Balanced Memory Hierarchy</h2>
